...
function LayoutNavigation(props) {
  return (
    <>
      <div className="mt-4 position-sticky top-0 d-none d-md-block bg-white width-full border-bottom">
        <div className="container-xl px-3 px-md-4 px-lg-5">
          <div className="gutter-condensed gutter-lg flex-column flex-md-row d-flex">
            ...
            <div className="flex-shrink-0 col-12 col-md-9 mb-4 mb-md-0">
              <div className="UnderlineNav width-full box-shadow-none">
                <div className="UnderlineNav-body">
                  <a className="UnderlineNav-item " href="/supreetsingh247">
                    <svg
                  ...
                  <a
                    ...
                    href="/supreetsingh247?tab=repositories"
                  >
                    <svg
                    ...
                    Repositories
                    <span className="Counter " title="12">
                      {props.repoCount || 0}
                    </span>
                  </a>
                  <a
                    className="UnderlineNav-item "
                    href="/supreetsingh247?tab=projects"
                  >
                    <svg
                    ...
                    Projects
                    <span className="Counter " title="0" hidden="hidden">
                      0
                    </span>
                  </a>
                </div>
